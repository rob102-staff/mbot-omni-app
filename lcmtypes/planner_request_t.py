...
class planner_request_t(object):
    ...
    __typenames__ = ["int64_t", "pose_xyt_t", "boolean"]

    __dimensions__ = [None, None, None]

    def __init__(self):
        self.utime = 0
        self.goal = pose_xyt_t()
    ...
    def _encode_one(self, buf):
        ...
        assert self.goal._get_packed_fingerprint() == pose_xyt_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.goal = pose_xyt_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x5942e2809bf67451+ pose_xyt_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
