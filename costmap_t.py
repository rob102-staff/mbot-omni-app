...
import cell_coordinate_t

class costmap_t(object):
    __slots__ = ["utime", "num_cells", "pairs", "distances"]

    __typenames__ = ["int64_t", "int32_t", "cell_coordinate_t", "float"]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_cells):
            assert self.pairs[i0]._get_packed_fingerprint() == cell_coordinate_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.pairs = []
        for i0 in range(self.num_cells):
            self.pairs.append(cell_coordinate_t._decode_one(buf))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x2c65402481f7ac9f+ cell_coordinate_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
