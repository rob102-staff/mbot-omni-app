...
from app.lcm_callbacks import LidarReader, OccupancyGridReader, PoseReader
...
lcm_callback_dict = {
    lcm_settings.SLAM_MAP_CHANNEL: OccupancyGridReader(socket, 'map', period=0.5),
    lcm_settings.LIDAR_CHANNEL: LidarReader(socket, 'lidar', period=0.5),
    lcm_settings.SLAM_POSE_CHANNEL: PoseReader(socket, 'pose', period=0.5)
}
