...
class particles_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_particles):
            assert self.particles[i0]._get_packed_fingerprint() == mbot_lcm_msgs.particle_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.particles = []
        for i0 in range(self.num_particles):
            self.particles.append(mbot_lcm_msgs.particle_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc48afb43c4cd5590+ mbot_lcm_msgs.particle_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
